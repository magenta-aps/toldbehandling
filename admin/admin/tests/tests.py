    ...
    def mock_requests_get(self, path):
        ...
        if path == expected_prefix + "vareafgiftssats/1":
            ...
            json_content = {
                ...
                "betales_af": "afsender",
                "alkohol_indførselstilladelse": "5678",
                "tobak_indførselstilladelse": "1234",
        ...
        self.assertEquals(
            ...
            [
                (
                    ...
                    "Enhed",
                    "Afgiftssats",
                    "Kræver alkoholindførselstilladelse",
                    "Kræver tobakindførselstilladelse",
    ...
    def mock_requests_get(self, path):
        ...
        if path == expected_prefix + "afgiftstabel":
            ...
            json_content = {
                ...
                "alkohol_indførselstilladelse": None,
                "tobak_indførselstilladelse": None,
