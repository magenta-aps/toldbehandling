...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        postnumre = (
            ...
            (3919, "Alluitsup Paa", 20, None),
            (3920, "Qaqortoq", 20, 20),
            (3921, "Narsaq", 20, 30),
            (3922, "Nanortalik", 20, 10),
            (3923, "Narsarsuaq", 20, 302),
            (3924, "Ikerasassuaq", 20, None),
            ...
            (3992, "Slædepatruljen SIRIUS", 0, None),
        )
        for postnummer, navn, dage, stedkode in postnumre:
            Postnummer.objects.update_or_create(
                postnummer=postnummer, defaults={"navn": navn, "dage": dage, "stedkode": stedkode,}
            )
