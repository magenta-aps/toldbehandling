...
class TF10Form(BootstrapForm):
    ...
    indførselstilladelse_alkohol = DynamicField(
        forms.CharField,
        max_length=12,
        required=False,
            ...
            attrs=(
                {
                    ...
                    "data-required-values": ",".join(
                        [
                            ...
                            if sats.kræver_indførselstilladelse_alkohol
                        ]
                    ),
                }
                if form.varesatser
    ...
    indførselstilladelse_tobak = DynamicField(
        forms.CharField,
        max_length=12,
        required=False,
            ...
            attrs=(
                {
                    ...
                    "data-required-values": ",".join(
                        [
                            str(id)
                            for id, sats in form.varesatser.items()
                            if sats.kræver_indførselstilladelse_tobak
                        ]
                    ),
                }
                if form.varesatser
    ...
    sidste_ændringsdato = forms.CharField(required=False)
                ...
                if self.varesatser and "vareafgiftssats" in subform.cleaned_data:
                    ...
                    if (
                        ...
                        self.add_error(
                            ...
                            _(
                                "Indførselstilladelse for alkohol er påkrævet med "
                    ...
                    if (
                        ...
                        self.add_error(
                            ...
                            _(
                                "Indførselstilladelse for tobak er påkrævet med "
                                "de angivne varearter"
                            ),
                        )
                        break
...
class TF10VareForm(BootstrapForm):
    ...
    mængde = ButtonlessDecimalField(min_value=0.0, required=False, decimal_places=3)
    antal = ButtonlessIntegerField(min_value=0, required=False)
